...
|`docker run --name jenkins_thalmann --user root --privileged -d -p 8080:8080 -p 50000:50000  -v /d/04_TG-C23/02_Python/docker_jenkis_ci:/app/python jenkins_thalmann2`|
|`docker exec -it jenkins_thalmann /bin/bash`|
